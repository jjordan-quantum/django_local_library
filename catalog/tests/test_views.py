...
from django.contrib.auth.models import Permission # Required to grant permission needed to set book returned
...
class AuthorListViewTest(TestCase):
	...
	def setUpTestData(cls):
		...
		# Create two users
		test_user1 = User.objects.create_user(username='testuser1', password='23erthyu7654')
		test_user2 = User.objects.create_user(username='testuser2', password='d7f687iuyhvg')
	...
	def test_view_url_exists_at_desired_location(self):
		login = self.client.login(username='testuser1', password='23erthyu7654')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
	def setUp(self):
		...
		test_book.genre.set(genre_objects_for_book) # Direct assignment of many-to-any types not allowed
		test_book.save()
	...
	def test_only_borrowed_books_in_list(self):
		...
		# Check that initially we don't have any books in the list (none on loan)
...
class RenewBookInstancesViewTest(TestCase):
	...
	def test_logged_in_with_permission_borrowed_book(self):
		login = self.client.login(username='testuser2', password='d7f687iuyhvg')
...
class AuthorCreateViewTest(TestCase):
	...
	def test_redirect_if_logged_in_but_not_not_correct_permission(self):
		login = self.client.login(username='testuser1', password='23erthyu7654')
		response = self.client.get(reverse('author_create'))
	...
	def test_redirects_to_detail_view_on_success(self):
		...
		# Manually chek redirect because we don't know what author was created
		self.assertEqual(response.status_code, 302)
